                ...
                <form action="{{ route('kelola-hasil.store') }}" class="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="laboratorium"
                            placeholder="Masukkan nama laboratorium penguji" value="{{ old('laboratorium') }}">
                    </div>
                    <div class="form-group">
