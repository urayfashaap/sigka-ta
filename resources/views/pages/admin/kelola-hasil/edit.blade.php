                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="titik-option" name="titik_pemantauan">
                                        @foreach ($titik_pemantauan as $titik)
                                            <option value="{{ $titik->id }}">{{ $item->TitikPemantauan->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="cuaca"
                                        placeholder="Masukkan cuaca saat pemantauan" value="{{ $item->cuaca }}">
                                </div>
                            </div>
                        </div>
                        <div class="baris" style="display: flex;  justify-content:space-between">
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="temperatur"
                                        placeholder="Masukkan nilai temperatur" value="{{ $item->temperatur }}">
                                </div>
                            </div>
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tds"
                                        placeholder="Masukkan nilai TDS" value="{{ $item->tds }}">
                                </div>
                            </div>
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tss"
                                        placeholder="Masukkan nilai TSS" value="{{ $item->tss }}">
                                </div>
                            </div>
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ph"
                                        placeholder="Masukkan nilai pH" value="{{ $item->ph }}">
                                </div>
                            </div>
                        </div>
                        <div class="baris" style="display: flex;  justify-content:space-between">
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="bod"
                                        placeholder="Masukkan nilai BOD" value="{{ $item->bod }}">
                                </div>
                            </div>
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="cod"
                                        placeholder="Masukkan nilai COD" value="{{ $item->cod }}">
                                </div>
                            </div>
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="do"
                                        placeholder="Masukkan nilai DO" value="{{ $item->do }}">
                                </div>
                            </div>
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="sulfat"
                                        placeholder="Masukkan nilai Sulfat" value="{{ $item->sulfat }}">
                                </div>
                            </div>
                        </div>
                        <div class="baris" style="display: flex;  justify-content:space-between">
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="clorida"
                                        placeholder="Masukkan nilai Klorida" value="{{ $item->clorida }}">
                                </div>
                            </div>
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nitrat"
                                        placeholder="Masukkan nilai Nitrat" value="{{ $item->nitrat }}">
                                </div>
                            </div>
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nitrit"
                                        placeholder="Masukkan nilai Nitrit" value="{{ $item->nitrit }}">
                                </div>
                            </div>
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="amoniak"
                                        placeholder="Masukkan nilai Amoniak" value="{{ $item->amoniak }}">
                                </div>
                            </div>
                        </div>
                        <div class="baris" style="display: flex;  justify-content:space-between">
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fosfat"
                                        placeholder="Masukkan nilai Fosfata" value="{{ $item->fosfat }}">
                                </div>
                            </div>
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="sianida"
                                        placeholder="Masukkan nilai Sianida" value="{{ $item->sianida }}">
                                </div>
                            </div>
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="merkuri"
                                        placeholder="Masukkan nilai Merkuri" value="{{ $item->merkuri }}">
                                </div>
                            </div>
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="besi"
                                        placeholder="Masukkan nilai Besi" value="{{ $item->besi }}">
                                </div>
                            </div>
                        </div>
                        <div class="baris" style="display: flex;  justify-content:space-between">
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="mangan"
                                        placeholder="Masukkan nilai Mangan" value="{{ $item->mangan }}">
                                </div>
                            </div>
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="seng"
                                        placeholder="Masukkan nilai Seng" value="{{ $item->seng }}">
                                </div>
                            </div>
                            <div class="kolom col-3">
                                <div class="form-group">
                            ...
                            <div class="kolom col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="detergen"
                                        placeholder="Masukkan nilai Detergen" value="{{ $item->detergen }}">
                                </div>
                            </div>
                        </div>
                        <div class="baris" style="display: flex;  justify-content:space-between">
                            <div class="kolom col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fenol"
                                        placeholder="Masukkan nilai Fenol" value="{{ $item->fenol }}">
                                </div>
                            </div>
                            <div class="kolom col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fecal_coliform"
                                        placeholder="Masukkan nilai Seng" value="{{ $item->fecal_coliform }}">
                                </div>
                            </div>
                            <div class="kolom col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="total_coliform"
                                        ...
                                        value="{{ $item->total_coliform }}">
                                </div>
                            </div>
                        </div>
                        <div class="baris" style="display: flex;  justify-content:space-between">
                            <div class="kolom col"> <button type="submit" class="btn btn-primary btn-block">Ubah Data
                                    Hasil Pemantauan</button></div>
                            <div class="kolom col"> <button class="btn btn-danger btn-block" type="button"
                                    name="cancel" value="cancel" onclick="history.go(-1)">Batal</button></div>
                        </div>
                    </div>
                </form>
            </div>
